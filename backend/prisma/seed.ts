...
// Boucle de pagination pour chaque marque
...
// Gestion des tags et catégories associées
          ...
          if (e instanceof Error) {
            console.error(` Erreur produit ${s.title} :`, e.message);
          } else {
            console.error(` Erreur produit ${s.title} :`, e);
          }
        }
      }
