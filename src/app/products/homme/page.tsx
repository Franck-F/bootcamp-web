      ...
      <section className="relative py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 overflow-hidden">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-blue-600/20 to-cyan-600/20 backdrop-blur-sm border border-blue-500/30 rounded-full px-6 py-3 mb-8">
              <Shirt className="w-5 h-5 text-blue-400" />
              <span className="text-sm font-semibold text-white">Collection Sneakers</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
              ...
              <div className="flex items-center border border-gray-700 rounded-xl bg-gray-900/50 backdrop-blur-sm">
                <Button
                  ...
                  className={`rounded-r-none ${viewMode === 'grid' ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800'}`}
                >
                ...
                <Button
                  ...
                  className={`rounded-l-none ${viewMode === 'list' ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800'}`}
                >
