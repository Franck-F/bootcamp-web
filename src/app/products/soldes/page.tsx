...
export default function SoldesPage() {
  ...
  const [filters, setFilters] = useState({
    ...
    sortBy: 'newest',
    brand: '',
    sale: true, // Filtre pour les soldes
  })
      ...
      <section className="relative py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 overflow-hidden">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-red-600/20 to-orange-600/20 backdrop-blur-sm border border-red-500/30 rounded-full px-6 py-3 mb-8">
              <Percent className="w-5 h-5 text-red-400" />
              <span className="text-sm font-semibold text-white">Soldes</span>
            ...
            <p className="text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed font-light">
              {loading ? (
                <span className="flex items-center justify-center space-x-2">
                  ...
                  <span>Chargement des meilleures offres...</span>
                </span>
              ) : (
                <>
                  Profitez de{' '}
                  <span className="text-white font-medium">{products.length} sneakers en promotion</span>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-12">
            ...
            {getActiveFiltersCount() > 0 && (
              <div className="flex flex-wrap gap-3">
                {filters.category && (
                  <Badge className="bg-red-600/20 text-red-400 border-red-500/30 px-3 py-1 flex items-center gap-2">
