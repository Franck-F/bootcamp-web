...
export default function FemmePage() {
  ...
  const [filters, setFilters] = useState({
    category: 'Marathon Running Shoes/Sneakers',
    search: '',
    minPrice: '',
    maxPrice: '',
    sortBy: 'newest',
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-pink-500/5 rounded-full blur-3xl"></div>
          <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-purple-500/5 rounded-full blur-3xl"></div>
        </div>

        <div className="w-full px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-pink-600/20 to-purple-600/20 backdrop-blur-sm border border-pink-500/30 rounded-full px-6 py-3 mb-8">
              <Heart className="w-5 h-5 text-pink-400" />
              <span className="text-sm font-semibold text-white">Running Shoes</span>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
              ...
              <div className="flex items-center border border-gray-700 rounded-xl bg-gray-900/50 backdrop-blur-sm">
                <Button
                  ...
                  className={`rounded-r-none ${viewMode === 'grid' ? 'bg-pink-600 hover:bg-pink-700 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800'}`}
                >
                ...
                <Button
                  ...
                  className={`rounded-l-none ${viewMode === 'list' ? 'bg-pink-600 hover:bg-pink-700 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800'}`}
                >
            ...
            {getActiveFiltersCount() > 0 && (
              <div className="flex flex-wrap gap-3">
                {filters.search && (
                  <Badge className="bg-pink-600/20 text-pink-400 border-pink-500/30 px-3 py-1 flex items-center gap-2">
